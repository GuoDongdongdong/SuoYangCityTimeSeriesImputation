...
class Model(BaseImputeModel):
    def __init__(self, exp_args:ExperimentArgs):
        ...
        self.d_input_embed = self.exp_args['d_input_embed']
        self.d_learnable_embed = self.exp_args['d_learnable_embed']
        self.d_proj = self.exp_args['d_proj']
        self.d_ffn = self.exp_args['d_ffn']
        self.n_temporal_heads = self.exp_args['n_temporal_heads']
        self.dropout = self.exp_args['dropout']
        self.input_dim = len(self.exp_args['targets'])
        self.output_dim = len(self.exp_args['targets'])
